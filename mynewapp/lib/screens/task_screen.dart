...
import 'package:mynewapp/model/todo.dart'; // Import ToDo model class
import 'package:mynewapp/widgets/todo_items.dart'; // Import ToDoItem widget
...
class _TasksScreenState extends State<TasksScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color.fromARGB(255, 230, 195, 24),
    );
  }
}